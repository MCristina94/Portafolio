    ...
    <div className="mx-4 sm:mx-10 md:mx-16 lg:mx-20 xl:mx-10">
        ...
        <div className="flex flex-col sm:flex-row my-4 sm:my-10">
            ...
            <div className="flex mt-5 lg:flex-row items-center justify-center lg:justify-between">
                <img src={js} alt="javaScript" className= "h-3.2 w-3.2 xl:mr-28 lg:mr-10 sm:mr-10" />
                <img src={java} alt="java" className= "h-3.2 w-3.2  xl:mr-28 lg:mr-10 sm:mr-10"/>  
            </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row my-4 sm:my-10">
            ...
            <div className="flex mt-5 lg:flex-row items-center justify-center lg:justify-between">
                <img src={vsc} alt="visual studio code" className= "h-3.2 w-3.2  xl:mr-28 lg:mr-10 sm:mr-10" />
                <img src={intelliji} alt="intelliji" className= "h-3.2 w-3.2 xl:mr-28 lg:mr-10 sm:mr-10"/>  
            </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row my-4 sm:my-10 mt-5">
            ...
            <div className="flex mt-5 lg:flex-row items-center justify-center lg:justify-between">
                <img src={react} alt="react" className= "h-3.2 w-3.2 xl:mr-28 lg:mr-10 sm:mr-10"/>
            </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row my-4 sm:my-10">
            ...
            <div className="flex mt-5 lg:flex-row items-center justify-center lg:justify-between">
            <img src={mysql} alt="mysql" className= "h-3.2 w-3.2 xl:mr-28 lg:mr-10 sm:mr-10" />
            </div>
        </div>
    </div>
  )
